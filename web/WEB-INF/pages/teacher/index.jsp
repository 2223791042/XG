...
<header class="navbar-wrapper">
    <div class="navbar navbar-fixed-top">
        <div class="container-fluid cl"><a class="logo navbar-logo f-l mr-10 hidden-xs" href="#">学工管理系统</a>
            <nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
                <ul class="cl">
                    <li>${teacher.teacherID}</li>
                    <li class="dropDown dropDown_hover"> <a href="#" class="dropDown_A">${teacher.teaName}<i class="Hui-iconfont">&#xe6d5;</i></a>
...
<aside class="Hui-aside">
    <div class="menu_dropdown bk_2">
        <c:forEach items="${menus}" var="menu">
            <dl>
                <dt><i class="Hui-iconfont">&#xe616;</i>${menu.menuName}<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
                <dd>
                    <ul>
                        <c:forEach items="${menu.menuList}" var="m">
                            <li><a data-href="${pageContext.request.contextPath}/${m.menuLink}" data-title="${m.menuName}" href="javascript:void(0)">${m.menuName}</a></li>
                        </c:forEach>
                    </ul>
                </dd>
            </dl>
...
<section class="Hui-article-box">
    ...
    <div id="iframe_box" class="Hui-article">
        <div class="show_iframe">
            ...
            <iframe scrolling="yes" frameborder="0" src="${pageContext.request.contextPath}/student/welcome"></iframe>
        </div>
    </div>
</section>
